...
package com.example.treinarapp;
...
import com.example.treinarapp.FaceMash.FaceMeshResultImageView;
...
public class MainActivity extends AppCompatActivity {
  ...
  private TextView formaRosto;
  @RequiresApi(api = Build.VERSION_CODES.N)
  @Override
  protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    setContentView(R.layout.activity_main2);
    formaRosto = findViewById(R.id.textoFace);
  ...
  private void setupStreamingModePipeline(InputSource inputSource) {
    ...
    glSurfaceView.setSolutionResultRenderer(new FaceMeshResultGlRenderer()); //Alterar Cores e Etc
    glSurfaceView.setRenderInputImage(true); //false - some com as Imagens true- mostras as imagens
    facemesh.setResultListener(
            faceMeshResult -> {
  ...
  private void logNoseLandmark(FaceMeshResult result, boolean showPixelValues) {
    ...
    //Centro da tela = x=0,500000, y=0,500000
    LandmarkProto.NormalizedLandmark noseLandmark = result.multiFaceLandmarks().get(0).getLandmarkList().get(1);
    // For Bitmaps, show the pixel values. For texture inputs, show the normalized coordinates.

    if(noseLandmark.getX() >= 0.400000 && noseLandmark.getX() <= 0.550000 &&
    noseLandmark.getY() >= 0.400000 && noseLandmark.getY() <= 0.550000) {
        formaRosto.setTextColor(Color.GREEN);
    }else {
        formaRosto.setTextColor(Color.RED);
    }
