...
package com.example.treinarapp.FaceMash;
...
public class FaceMeshResultGlRenderer implements ResultGlRenderer<FaceMeshResult> {
  ...
  private static final float[] RIGHT_EYE_COLOR = new float[] {0.9f, 0.9f, 0.9f, 1f};
  ...
  private static final float[] LEFT_EYE_COLOR = new float[] {0.9f, 0.9f, 0.9f, 1f};
